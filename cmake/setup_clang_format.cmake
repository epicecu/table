...
if(NOT apt_get OR NOT dpkg_deb)
  message(FATAL_ERROR "ClangFormat 18 was not found. Install it or provide CLANG_FORMAT explicitly")
endif()

set(package_directory "${OUTPUT}/packages")
file(MAKE_DIRECTORY "${package_directory}")
execute_process(COMMAND "${apt_get}" download clang-format-18 WORKING_DIRECTORY "${package_directory}" RESULT_VARIABLE download_result)
