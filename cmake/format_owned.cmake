...
file(GLOB_RECURSE owned_files
  ...
  "${ROOT}/src/*.h"
  "${ROOT}/src/*.hpp"
  "${ROOT}/extras/nanopb/table/nanopb.c"
  "${ROOT}/extras/nanopb/table/nanopb.h"
  "${ROOT}/examples/*.c"
  "${ROOT}/examples/*.cpp"
  "${ROOT}/examples/*.ino"
  "${ROOT}/tests/unit/*.cpp"
  "${ROOT}/tests/integration/*.c"
  "${ROOT}/tests/integration/*.cpp"
  "${ROOT}/tests/integration/package/*.c"
  "${ROOT}/tests/integration/package/*.cpp"
)
list(FILTER owned_files EXCLUDE REGEX "/generated/")
list(FILTER owned_files EXCLUDE REGEX "\\.pb\\.[ch]$")
...
message(STATUS "${MODE} formatting completed for owned Table sources")
